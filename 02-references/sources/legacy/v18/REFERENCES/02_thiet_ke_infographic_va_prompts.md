...
> Phân rã từ các slide mẫu thực chiến chuẩn Enterprise / Banking / Tech Training (KPIM standard).  
> Cung cấp thông số hình học, token màu sắc, giải phẫu thẻ (Card Anatomy) và bộ công thức prompt AI (Flux.1 / Midjourney v6 / DALL-E 3) với **ưu tiên mặc định là 2D Flat / Vector hiện đại**, và 3D là tùy chọn opt-in.

---

## 0. Quy chuẩn Phong cách: 2D Flat/Vector (Mặc định) vs 3D (Tùy chọn)

| Tiêu chí | 2D Flat / Vector Infographic (MẶC ĐỊNH) | 3D Claymorphism / Isometric (OPT-IN) |
|---|---|---|
| **Mục đích chính** | **Slide đào tạo, giải thích quy trình, nhiều thông tin** | **Slide bìa (Cover), Section divider, hoặc Slide rất ít chữ** |
| **Không gian chiếm dụng** | Rất gọn, đường nét mỏng, tối đa diện tích cho text & whitespace | Cồng kềnh, chiếm nhiều diện tích, đổ bóng lan tỏa |
| **Độ tương phản & Đọc** | **Cực cao**: Text và icon tách bạch rõ ràng, không bị chìm | Dễ bị tranh chấp thị giác giữa hiệu ứng bóng bẩy và chữ nhỏ |
| **Tốc độ tiếp thu** | Não quét cấu trúc trong **1–2 giây** | Não tốn thời gian ngắm chi tiết 3D trước khi đọc chữ |
| **Khi nào dùng?** | Mặc định cho mọi slide nội dung, bước, bảng so sánh | Chỉ dùng khi người dùng yêu cầu, hoặc 1 vật thể hero duy nhất |
