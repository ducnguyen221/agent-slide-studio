...
1. **Intake.** Chọn đúng slide, nội dung, audience, đầu ra và reference. Nếu dùng thư viện phong cách, khóa một `style_id` từ [style library](../references/style-library/index.md) và một ảnh chính; ảnh phụ chỉ dùng khi bổ sung một đặc tính riêng, không trộn nhiều style. Dùng 1920×1080/16:9/lề 5% khi chưa có lựa chọn khác, nêu đó là giả định. Giữ 4:3 hoặc custom khi đã yêu cầu. Xác định cần exact-size hay chỉ exact-ratio; mặc định exact-size.
