...
Căn cứ nội bộ cho bản viết độc lập: [đặc tả](../../../docs/superpowers/specs/2026-09-14-slide-infographic-design.md), [kế hoạch specialist](../../../docs/superpowers/plans/2026-09-14-slide-infographic-b-skill.md) và [giới hạn baseline](../../../evals/slide-infographic/cases.md). Những kế hoạch rộng hơn có runtime/HTML là lịch sử thiết kế; phạm vi hoạt động của gói này là Markdown cho Codex Image, không tự mở Phase 2.
