...
Áp dụng cho [cases](cases.md), [skill](../../skills/slide-infographic/SKILL.md) và [quy trình](../../processes/slide-infographic-image.md). Đây là hướng dẫn chấm thủ công; không có scorer/runtime trong gói này.
...
| C5 — Claim và bàn giao | Khai raster/overlay-ready chính xác; đủ prompt, ảnh, QA, giới hạn | Artifact hiện có và bản ghi [QA](../../skills/slide-infographic/references/qa.md) |
