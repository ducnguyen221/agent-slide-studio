...
def gallery(root,groups,allr):
 ...
 text='''<!doctype html><html lang="vi"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>AIA · Danh mục bố cục có phân loại</title><style>
