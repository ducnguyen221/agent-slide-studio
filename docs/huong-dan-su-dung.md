...
Nếu dùng Codex host để tạo một ảnh infographic, đọc [skill slide-infographic](../skills/slide-infographic/SKILL.md), [workflow tạo ảnh](../skills/slide-infographic/workflows/create-slide-infographic.md) và [hợp đồng agent](../skills/slide-infographic/agents/slide-infographic-agent.md). Mặc định TEXT_SAFE giữ chữ Việt nguyên văn để đặt lớp chữ sau; DIRECT_TEXT chỉ best-effort với QA từng nhãn; NO_TEXT dành cho hình không chữ. Muốn kế thừa mẫu đã chọn, khóa một profile trong [style library](../skills/slide-infographic/references/style-library/index.md); ảnh ChatGPT riêng đặt dưới `~/.presentation/style-references/` và không đưa vào Git. Gói hướng dẫn này chỉ có Markdown/YAML metadata, không thêm lệnh `presentation` hay runtime. Kết quả ảnh/overlay-ready phải được đo và xem thực; [eval](../skills/slide-infographic/evals/cases.md) ghi riêng các phần chưa chạy.
